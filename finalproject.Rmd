...
merged_data <- inner_join(longer_gdp, longer_population, longer_income, by = c("GeoName", "Year")) 
merged_data <-inner_join(merged_data, longer_income_percap, by = c("GeoName", "Year")) 
...
ui <- fluidPage(theme = shinytheme("sandstone"),
                ...
                titlePanel("Comparing Regional Differences in Economic Growth"),
                              ...
                              sidebarPanel(
                                radioButtons("indicator",
                                             ...
                                             choices = c("Gross Domestic Product (GDP)" = "GDP",
                                                         ...
                                                         "Personal Consumption Income (PCE)" = "income",
                                                         "PCE per capita" = "perCapIncome"),
                                             selected = "GDP"),
